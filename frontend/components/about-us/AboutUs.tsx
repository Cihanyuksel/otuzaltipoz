...
import { MdOutlineCollections as CollectionIcon } from "react-icons/md";
              ...
              <div className="space-y-6 text-gray-700 leading-relaxed">
                ...
                <div>
                  ...
                  <ul className="space-y-2 list-disc list-inside text-gray-700">
                    <li>
                      <span className="font-semibold">Yaratıcılık:</span> Özgünlüğü ve farklı
                      sanatsal tarzları destekliyoruz.
                    </li>
                    <li>
                      <span className="font-semibold">Topluluk:</span> Bağlantı ve işbirliği için
                      destekleyici bir ortam sağlıyoruz.
                    </li>
                    <li>
                      <span className="font-semibold">Kapsayıcılık:</span> Her kökenden yaratıcıyı
                      memnuniyetle karşılıyor ve kutluyoruz.
                    </li>
                    <li>
                      <span className="font-semibold">Yenilikçilik:</span> Kullanıcı deneyimini
                      geliştirmek ve yaratıcıları güçlendirmek için sürekli gelişiyoruz.
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                <div className="flex flex-col items-center">
                  <div className="flex items-center justify-center h-12 w-12 rounded-full bg-[#e6a84c]/20 text-[#e6a84c] mb-4">
                    <span className="material-symbols-outlined">{<GalleryIcon/>}</span>
                  </div>
                  <h3 className="text-lg font-semibold text-gray-900 mb-1">Etkileyici Galeriler</h3>
                  <p className="text-gray-600 text-sm">
                    Çalışmalarınızı görsel olarak büyüleyici düzenlerde sergileyin.
                  </p>
                </div>
                <div className="flex flex-col items-center">
                  <div className="flex items-center justify-center h-12 w-12 rounded-full bg-[#e6a84c]/20 text-[#e6a84c] mb-4">
                  ...
                  <p className="text-gray-600 text-sm">
                    Yorumlar, beğeniler ve paylaşımlarla diğer yaratıcılarla bağlantı kurun.
                  </p>
                </div>
                <div className="flex flex-col items-center">
                  <div className="flex items-center justify-center h-12 w-12 rounded-full bg-[#e6a84c]/20 text-[#e6a84c] mb-4">
                  ...
                  <p className="text-gray-600 text-sm">
                    Ekibimiz ve topluluğumuz tarafından hazırlanan temalı galerileri keşfedin.
                  </p>
                </div>
              </div>
            </div>
