      ...
      <div className="flex w-full max-w-lg flex-col items-center rounded-xl bg-[#d3deda] p-8 shadow-lg">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="w-full space-y-6">
          ...
          <div className="flex justify-end pt-4">
            <button
              className="flex min-w-[84px] cursor-pointer items-center justify-center overflow-hidden rounded-lg bg-[#e6994c] h-12 px-8 text-base font-bold text-white shadow-lg transition-transform hover:scale-105"
              type="submit"
