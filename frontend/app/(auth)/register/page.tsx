...
export default async function RegisterPage() {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center py-10">
      ...
      <div className="relative z-10 bg-[#f5f0e9] p-6 sm:p-8 rounded-2xl shadow-2xl w-full max-w-lg mx-4">
        <h1 className="text-3xl font-extrabold text-[#ef7464] mb-2 text-center hidden">Kayıt Ol</h1>
