        ...
        {status === 'success' && (
          <div className="flex flex-col items-center space-y-4">
            ...
            <Button
              ...
              variant="primary"
              size="medium"
              className="mt-6 w-full flex items-center justify-center px-4 py-2 border border-transparent text-base font-medium rounded-md shadow-sm text-white bg-indigo-600 hover:bg-indigo-700"
            >
        ...
        {status === 'error' && (
          <div className="flex flex-col items-center space-y-4">
            ...
            <Button
              ...
              variant="primary"
              size="medium"
              className="mt-6 w-full flex items-center justify-center px-4 py-2 border border-transparent text-base font-medium rounded-md shadow-sm text-indigo-600 bg-indigo-100 hover:bg-indigo-200"
            >
              <LoginIcon className="w-5 h-5 mr-2" />
              Giriş Sayfasına Git
            </Button>
